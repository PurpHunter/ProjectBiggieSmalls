...
// Make reminder per-user so users don't overwrite each other
$reminderFile = __DIR__ . DIRECTORY_SEPARATOR . 'reminder_' . intval($_SESSION['user_id']) . '.txt';
$currentReminder = "";
...
function closeReminder() {
  ...
  document.getElementById("menu").style.opacity = "1";
  location.reload(); // ✅ refresh menu so reminder updates
}
</script>
